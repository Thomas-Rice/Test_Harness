...
originalNodes = set([('OneView1', 'C_SphericalTransform7', 'JoinViews1'), 
                    ('OneView2', 'C_SphericalTransform1', 'JoinViews1'), 
                    ('OneView3', 'C_SphericalTransform2', 'JoinViews1'), 
                    ('OneView4', 'C_SphericalTransform3', 'JoinViews1'), 
                    ('OneView5', 'C_SphericalTransform4', 'JoinViews1'), 
                    ('OneView6', 'C_SphericalTransform5', 'JoinViews1'),
                    ('Split', 'JoinViews1')])
